SYMBOL_DEPENDENCIES=
SYMBOL_MODULE=./src/Symbol/Symbol.c $(SYMBOL_DEPENDENCIES)
SYMBOL_TEST_MODULE=$(SYMBOL_MODULE) ./src/Symbol/test/Main.c
SYMBOL_TEST_NAME=SymbolTest

LABEL_DEPENDENCIES=
LABEL_MODULE=./src/Label/Label.c $(LABEL_DEPENDENCIES)
LABEL_TEST_MODULE=$(LABEL_MODULE) ./src/Label/test/Main.c
LABEL_TEST_NAME=LabelTest

PARSER_DEPENDENCIES=$(SYMBOL_MODULE) $(LABEL_DEPENDENCIES)
PARSER_MODULE=./src/Parser/Parser.c $(PARSER_DEPENDENCIES)
...
main:
	...
	gcc ./src/Main.c $(PARSER_MODULE) -o $(BIN)
debug:
	$(REMOVE_FILE_IF_EXISTS)
